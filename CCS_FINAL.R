# ARYAN GUPTA
# Data Science using R  (batch 2018-19)
# aryangupta1802@gmail.com
...
Cred_seg<-read.table(file = "CCGeneral.csv",header = TRUE, sep=",")
View(Cred_seg)
...
write.csv(Cred_seg,file = "F:/Aryan/MLProjects/CC Segmentation/Outputs/Cred_seg.csv")
...
View(diag_stats)
write.csv(diag_stats,file = "F:/Aryan/MLProjects/CC Segmentation/Outputs/Diag_stat.csv")
...
write.csv(Cred_seg,file = "F:/Aryan/MLProjects/CC Segmentation/Outputs/MissingValuesTreated.csv")
...
write.csv(Cred_seg,file = "F:/Aryan/MLProjects/CC Segmentation/Outputs/outlierTreated.csv")
...
write.csv(corrm1,file = "F:/Aryan/MLProjects/CC Segmentation/Outputs/CorrelationMatrix1.csv")
...
View(CorrM)
write.csv(CorrM,file = "F:/Aryan/MLProjects/CC Segmentation/Outputs/CorrelationMatrix2.csv")
...
write.csv(eigen_values,file = "F:/Aryan/MLProjects/CC Segmentation/Outputs/Eigen_Values.csv")
...
View(Loadings)
write.csv(Loadings,file = "F:/Aryan/MLProjects/CC Segmentation/Outputs/Loadings.csv")
names(Final_data1)
...
View(clust_data2)
write.csv(clust_data2,file = "F:/Aryan/MLProjects/CC Segmentation/Outputs/clustdata.csv")
...
write.csv(profile1,file = "F:/Aryan/MLProjects/CC Segmentation/Outputs/profile1.csv",row.names = F)
write.csv(profile2,file = "F:/Aryan/MLProjects/CC Segmentation/Outputs/profile2.csv",row.names = F)
